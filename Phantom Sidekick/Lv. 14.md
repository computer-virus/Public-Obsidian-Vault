...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="110" placeholder="#" value="110" /> / 110 (17d8 + 34)|**Hit Die** <input type="number" step="1" min="0" max="17" placeholder="#" value="17" /> / 17|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 14, PB +5
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 14 hit points.