...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="27" placeholder="#" value="27" /> / 27 (6d8)|**Hit Die** <input type="number" step="1" min="0" max="6" placeholder="#" value="6" /> / 6|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 3, PB +2
> 
> ## Traits
> 
> **Chilling Phasing**
...
> 1 / Long Rest: [Hellish Rebuke](https://www.dndbeyond.com/spells/2619149-hellish-rebuke) <input type="checkbox" checked />
> 
> **Vicious Attacker**
...
> The phantom regains 1d10 + 3 hit points.