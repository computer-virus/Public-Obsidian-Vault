...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="88" placeholder="#" value="88" /> / 88 (16d8 + 16)|**Hit Die** <input type="number" step="1" min="0" max="16" placeholder="#" value="16" /> / 16|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 13, PB +5
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 13 hit points.