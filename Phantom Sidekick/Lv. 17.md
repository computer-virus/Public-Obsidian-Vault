...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="150" placeholder="#" value="150" /> / 150 (20d8 + 60)|**Hit Die** <input type="number" step="1" min="0" max="20" placeholder="#" value="20" /> / 20|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 17, PB +6
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 17 hit points.