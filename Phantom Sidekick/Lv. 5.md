...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="44" placeholder="#" value="44" /> / 44 (8d8 + 8)|**Hit Die** <input type="number" step="1" min="0" max="8" placeholder="#" value="8" /> / 8|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 5, PB +3
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 5 hit points.