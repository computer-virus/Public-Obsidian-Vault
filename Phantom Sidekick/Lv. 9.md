...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="66" placeholder="#" value="66" /> / 66 (12d8 + 12)|**Hit Die** <input type="number" step="1" min="0" max="12" placeholder="#" value="12" /> / 12|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 9, PB +4
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 9 hit points.