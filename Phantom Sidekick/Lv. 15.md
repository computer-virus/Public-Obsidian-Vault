...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="117" placeholder="#" value="117" /> / 117 (18d8 + 36)|**Hit Die** <input type="number" step="1" min="0" max="18" placeholder="#" value="18" /> / 18|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 15, PB +5
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 15 hit points.