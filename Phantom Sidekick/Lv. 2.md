...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="22" placeholder="#" value="22" /> / 22 (5d8)|**Hit Die** <input type="number" step="1" min="0" max="5" placeholder="#" value="5" /> / 5|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 2, PB +2
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 2 hit points.