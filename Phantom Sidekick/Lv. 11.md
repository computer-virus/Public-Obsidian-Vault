...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="77" placeholder="#" value="77" /> / 77 (14d8 + 14)|**Hit Die** <input type="number" step="1" min="0" max="14" placeholder="#" value="14" /> / 14|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 11, PB +4
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 11 hit points.