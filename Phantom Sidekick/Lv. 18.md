...
> |---|---|
> |**HP** <input type="number" step="1" min="0" max="157" placeholder="#" value="157" /> / 157 (21d8 + 63)|**Hit Die** <input type="number" step="1" min="0" max="21" placeholder="#" value="21" /> / 21|
> |**Speed** 40 ft.||
> 
> |||MOD|SAVE|||MOD|SAVE|
> |---|---|---|---|---|---|---|---|
...
> **Level** Sidekick (Warrior/Attacker) 18, PB +6
> 
> ## Traits
> 
> **Chilling Phasing**
...
> The phantom regains 1d10 + 18 hit points.